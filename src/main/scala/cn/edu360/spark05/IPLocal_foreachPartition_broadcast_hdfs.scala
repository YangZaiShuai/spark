...
//3\ 在hdfs读取ip规则库
object IPLocal_foreachPartition_broadcast_hdfs {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //定义一个累加器
    val longacc = sc.longAccumulator("longacc")
    val longacc2 = sc.longAccumulator("longacc")
